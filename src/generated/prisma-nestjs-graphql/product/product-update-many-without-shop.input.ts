...
@InputType()
export class ProductUpdateManyWithoutShopInput {
    ...
    @Field(() => [ProductUpsertWithWhereUniqueWithoutShopInput], {nullable:true})
    ...
    @Field(() => [ProductUpdateWithWhereUniqueWithoutShopInput], {nullable:true})
