...
import { UsersOnShopsUpdateManyWithoutUserInput } from '../users-on-shops/users-on-shops-update-many-without-user.input';
...
export class UserUpdateInput {
  ...
  @Field(() => UsersOnShopsUpdateManyWithoutUserInput, { nullable: true })
